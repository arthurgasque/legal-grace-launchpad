    ...
    <section className="bg-gradient-red py-12 sm:py-16 lg:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p 
            className="text-base sm:text-lg lg:text-xl text-white/95 mb-6 max-w-3xl mx-auto leading-relaxed"
            data-aos="fade-up"
            data-aos-delay="200"
          >
          ...
          <p 
            className="text-sm sm:text-base text-white/90 mb-8 max-w-2xl mx-auto"
            data-aos="fade-up"
            data-aos-delay="300"
          >
